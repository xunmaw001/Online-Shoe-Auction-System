...
public class YonghupingjiaController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YonghupingjiaEntity yonghupingjia, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			yonghupingjia.setYonghuming((String)request.getSession().getAttribute("username"));
		}

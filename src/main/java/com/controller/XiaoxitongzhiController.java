...
public class XiaoxitongzhiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XiaoxitongzhiEntity xiaoxitongzhi, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XiaoxitongzhiEntity xiaoxitongzhi, HttpServletRequest request){
        EntityWrapper<XiaoxitongzhiEntity> ew = new EntityWrapper<XiaoxitongzhiEntity>();
		PageUtils page = xiaoxitongzhiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xiaoxitongzhi), params), params));
        return R.ok().put("data", page);
    }

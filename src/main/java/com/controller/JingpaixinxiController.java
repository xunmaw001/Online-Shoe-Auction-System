...
public class JingpaixinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JingpaixinxiEntity jingpaixinxi, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			jingpaixinxi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
